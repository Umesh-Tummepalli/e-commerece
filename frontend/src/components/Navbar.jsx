    ...
    <nav className="text-black flex justify-between items-center p-6 px-4 sm:px-8 border-b border-gray-100 shadow-sm bg-white  top-0 z-50">
      ...
      <div className="flex items-center gap-5 sm:gap-6">
        ...
        <Link to="/cart" className="relative">
          ...
          <p className="absolute -top-2 -right-2 bg-black hidden text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">
            {cartSize || 0}
          </p>
        </Link>
        ...
        {/* Mobile Navigation */}
        <div
          className={`sm:hidden fixed inset-0 bg-white z-40 transition-all duration-300 ease-in-out ${
